...
try:
    uart = Serial("COM6", baudrate=57600, timeout=1)
    # uart = Serial("/dev/ttyUSB0", baudrate=57600, timeout=1)
except:
    uart = Serial("COM5", baudrate=57600, timeout=1)
    # uart = Serial("/dev/ttyUSB1", baudrate=57600, timeout=1)
